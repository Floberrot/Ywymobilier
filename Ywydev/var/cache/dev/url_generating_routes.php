...
return [
    ...
    'contact' => [[], ['_controller' => 'App\\Controller\\ContactController::new'], [], [['text', '/contact']], [], []],
    'Home' => [[], ['_controller' => 'App\\Controller\\HomeController::index'], [], [['text', '/']], [], []],
    'inscription' => [[], ['_controller' => 'App\\Controller\\LoginController::new'], [], [['text', '/inscription']], [], []],
    ...
    'Offres' => [[], ['_controller' => 'App\\Controller\\OfferController::index'], [], [['text', '/offres']], [], []],
    'getOffer' => [[], ['_controller' => 'App\\Controller\\OfferController::getOffer'], [], [['text', '/offres/get']], [], []],
    'property.show' => [['slug', 'id'], ['_controller' => 'App\\Controller\\OfferController::show'], ['slug' => '[a-z0-9/-]*'], [['variable', '.', '[^/]++', 'id', true], ['variable', '/', '[a-z0-9/-]*', 'slug', true], ['text', '/offres']], [], []],
    'logout' => [[], [], [], [['text', '/logout']], [], []],
];
